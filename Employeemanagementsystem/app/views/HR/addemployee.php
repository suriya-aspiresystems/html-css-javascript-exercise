...
<body>
    <div class ="container my-5">
        ...
        <form method ="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" name="designation" id="name" class="form-control" value="" placeholder="Enter your Designation" >
                </div>
            </div>
            <div class="row mb-3">
    ...
    <script src="<?php "echo BASEURL";?>assests/javascript/validate.js"></script>
</body>
</html>