...
<body>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                ...
                <div class="container my-5">
                    ...
                    <button class="btn btn-primary"><a href="http://localhost/Employeemanagementsystem/public/undoemployee" class="text-light" style="text-decoration:none;cursor:pointer;">Deleted Employee Records</a></button>
                    <div class="col">
                        <table class="table bg-white rounded shadow-sm table-hover" style="cursor: pointer;">
                            ...
                            <tr>
                                ...
                                <button class="btn btn-danger"><a href="deleteemployee?deletedata=<?php echo $row['id'];?>&&type=delete" class="text-light" style="text-decoration:none;cursor:pointer;">Delete</a></button>
                               </td>
                            </tr>
                                <?php
                                    $count++;
    ...
    <script>
        ...
        function goPage()
        {
            ...
            window.location.href = 'hrdetails?page='+page;
        }
    </script>
</body>
